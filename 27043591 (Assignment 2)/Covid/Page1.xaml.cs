...
namespace News
{
    ...
    public sealed partial class MainPage : Page, INotifyPropertyChanged
    {
        ...
        private DataItem hero;

        public DataItem Hero
        {
            get { return hero; }
        ...
        private void Timeline_ItemInvoked(object sender, TimelineItemInvokedEventArgs e)
        {
            ...
            DataItem item = e.Item.DataContext as DataItem;
        ...
        private void ListView_ItemClick(object sender, ItemClickEventArgs e)
        {
           Frame.Navigate(typeof(DetailsPage));
            ...
            /*
            var index = Items.IndexOf(e.ClickedItem as DataItem);
            ...
            var story = e.ClickedItem as DataItem;

            RootPage.Current.UpdateBackground(story.HeroImage, 0);
            Frame.Navigate(typeof(RootPage),story);
